...
public:
	...
	**/
	void minimoACima() {
		...
		Nodo* candidato = _cima;
		Nodo* anterior_candidato = nullptr;
		

		while (recorre != nullptr) {//Recorremos y buscamos el menor
			
			if (candidato->_elem>recorre->_elem) {
				candidato = recorre;
				anterior_candidato = anterior;
			}
		...
		anterior_candidato->_sig = candidato->_sig;
		
		candidato->_sig = _cima;
		_cima = candidato;
