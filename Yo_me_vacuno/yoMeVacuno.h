...
private:  
   // A INCLUIR DETALLES DE REPRESENTACION
    tAnio _anio;
    tNumVacunas _numVacunas;
    Diccionario<tIdCentro, DatosCentro> _centros;
    Diccionario<tIdCiudadano, DatosCiudadano> _poblacion;
};

class DatosCentro {
public:
    DatosCentro(tDireccion direccion) {
        _filaEspera = Cola<tIdCiudadano>();
        _direccion = direccion;
    }
private:
    Cola<tIdCiudadano> _filaEspera;
    tDireccion _direccion;
